...
public static class Log
{
	...
	public readonly struct Event(DateTime utc, Level level, string message, Exception? exception, Affinity affinity)
	{
		public readonly DateTime Utc = utc;
		public readonly Level Level = level;
		public readonly string Message = message;
		public readonly Exception? Exception = exception;
		public readonly Affinity Affinity = affinity;

		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public override string ToString() => $"[{Utc:O}][{Level}][{Affinity}] {Message}" + (Exception is null ? "" : Environment.NewLine + Exception);
	}
	...
	internal static class Core
	{
		...
		[ThreadStatic] public static Affinity Affinity;
		...
		public static void Write(Level level, string message, Exception? ex = null)
		{
			...
			var ev = new Event(DateTime.UtcNow, level, message, ex, Affinity);
