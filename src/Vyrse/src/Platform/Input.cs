...
//
// namespace Vyrse.Platform;
//
// [Discoverable]
// public sealed class Input : Module<Input>, IModule
// {
...
// 	public void Update()
// 	{
// 		// _snapshot = Receive<InputSnapshot>();
// 		//
...
// 	public ref Action OnEvent(Key key, Event type) => ref CollectionsMarshal.GetValueRefOrAddDefault(_handlers, (key, type), out _)!;
//
// 	[MethodImpl(MethodImplOptions.AggressiveInlining)]
// 	public ref Action<Key> OnAny(Event type) => ref CollectionsMarshal.GetValueRefOrAddDefault(_anyKeyHandlers, type, out _)!;
//
// 	[MethodImpl(MethodImplOptions.AggressiveInlining)]
...
//
// 	[MethodImpl(MethodImplOptions.AggressiveInlining)]
// 	public bool PressedChord(Modifiers modifier, Key key) => (_state.Modifiers & modifier) == modifier && WasKeyPressed(key);
//
...
// 			bool make = ((RI_KEY)flags & RI_KEY.BREAK) == 0;
//
...
// 			// if (((RI_KEY)flags & RI_KEY.E0) != 0) scanCode |= 0xE000;
// 			// if (((RI_KEY)flags & RI_KEY.E1) != 0) scanCode |= 0xE100;
...
//
// 	[MethodImpl(MethodImplOptions.AggressiveInlining)]
// 	public ref Action OnEvent(Button button, Event type) => ref CollectionsMarshal.GetValueRefOrAddDefault(_handlers, (button, type), out _)!;
//
// 	[MethodImpl(MethodImplOptions.AggressiveInlining)]
...
//
//
// 			switch (mouse.ButtonFlags)
// 			{
// 				case RI_MOUSE.LEFT_BUTTON_DOWN:
// 				{
// 					_held |= Button.Left;
// 					_pressed |= Button.Left;
// 					break;
// 				}
// 				case RI_MOUSE.LEFT_BUTTON_UP:
// 				{
// 					_held &= ~Button.Left;
// 					_released |= Button.Left;
// 					break;
// 				}
// 				case RI_MOUSE.RIGHT_BUTTON_DOWN:
// 				{
// 					_held |= Button.Right;
// 					_pressed |= Button.Right;
// 					break;
// 				}
// 				case RI_MOUSE.RIGHT_BUTTON_UP:
// 				{
// 					_held &= ~Button.Right;
// 					_released |= Button.Right;
// 					break;
// 				}
// 				case RI_MOUSE.MIDDLE_BUTTON_DOWN:
// 				{
// 					_held |= Button.Middle;
// 					_pressed |= Button.Middle;
// 					break;
// 				}
// 				case RI_MOUSE.MIDDLE_BUTTON_UP:
// 				{
// 					_held &= ~Button.Middle;
// 					_released |= Button.Middle;
// 					break;
// 				}
// 				case RI_MOUSE.BUTTON_4_DOWN:
// 				{
// 					_held |= Button.XButton1;
// 					_pressed |= Button.XButton1;
// 					break;
// 				}
// 				case RI_MOUSE.BUTTON_4_UP:
// 				{
// 					_held &= ~Button.XButton1;
// 					_released |= Button.XButton1;
// 					break;
// 				}
// 				case RI_MOUSE.BUTTON_5_DOWN:
// 				{
// 					_held |= Button.XButton2;
// 					_pressed |= Button.XButton2;
// 					break;
// 				}
// 				case RI_MOUSE.BUTTON_5_UP:
// 				{
// 					_held &= ~Button.XButton2;
...
// 		}
//
// 		public FrameState BuildFrameState(long timestamp) => new()
// 			{
// 				Delta = _lastDelta,
