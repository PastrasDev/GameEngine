...
public sealed class Code
{
	...
	public static Code operator +(Code a, Code b)
	{
		...
		var leftEndsWithSpace = a.Text.EndsWith(" ");
		var rightStartsWithSpace = b.Text.StartsWith(" ");

		var text = leftEndsWithSpace || rightStartsWithSpace ? a.Text + b.Text : a.Text + " " + b.Text;
